...
public class HomeFragment extends Fragment implements MovieAdapter.UserCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        changeaz = v.findViewById(R.id.changeAtoZ);
        changeza = v.findViewById(R.id.changeZtoA);
        ...
        TabLayout tabLayout = v.findViewById(R.id.tabCategory);
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (position) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Query query2 = collectionRef.whereEqualTo("Category", "Hoạt Hình");
        ...
        CollectionReference data = db.collection("Movie");
        Query query = data.orderBy("Name");
        EventChangeListener(query);
        changeaz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Query query = data.orderBy("Name", Query.Direction.ASCENDING);
                Toast.makeText(getContext(), "Phim đã được sắp xếp theo thứ tự A-Z", Toast.LENGTH_SHORT).show();
                EventChangeListener(query);
            }
        });
        changeza.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Query query = data.orderBy("Name", Query.Direction.DESCENDING);
                Toast.makeText(getContext(), "Phim đã được sắp xếp theo thứ tự Z-A", Toast.LENGTH_SHORT).show();
                EventChangeListener(query);
            }
        });
        recyclerViews.setAdapter(movieAdapter);
