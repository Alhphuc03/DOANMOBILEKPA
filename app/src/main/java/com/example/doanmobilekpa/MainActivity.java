...
public class MainActivity extends AppCompatActivity implements MovieAdapter.UserCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.findItem(R.id.mnuHome).setChecked(true);
...
//                String titleText = "KPA MOVIE";
//                String styledText = "<font color='#FF0000'><b>" + titleText + "</b></font>";
//                getSupportActionBar().setTitle(Html.fromHtml(styledText));
                    // Ẩn tiêu đề
                getSupportActionBar().setDisplayShowTitleEnabled(false);

                // Cho phép sử dụng View tùy chỉnh
                getSupportActionBar().setDisplayShowCustomEnabled(true);
                // Thiết lập View tùy chỉnh
                    ...
                    query.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                        ...
                        public void onSuccess(QuerySnapshot querySnapshot) {
                            ...
                            for (DocumentSnapshot document : querySnapshot) {
                                ...
                                if (movieName.equals(searchText)) {
                                    movieArrayList.clear();
                                    movieArrayList.add(movie);
                                    break;
                                } else if (movieName.contains(searchText)) {
                                    movieArrayList.add(movie);
                                }
                            }
